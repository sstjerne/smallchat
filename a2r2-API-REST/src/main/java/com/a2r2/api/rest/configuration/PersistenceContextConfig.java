...
@EnableJpaRepositories(basePackages = "com.a2r2.api.rest.persistence")
@ComponentScan({ "com.a2r2.api.rest.persistence" })
...
public class PersistenceContextConfig {
	...
	public DataSource dataSource() {
		...
		if (env.containsProperty("jdbc.user")) {
	...
	public LocalValidatorFactoryBean validator() {
		LocalValidatorFactoryBean messageSource = new LocalValidatorFactoryBean();
		messageSource.setValidationMessageSource(messageSource());
